            ...
            <div className="flex items-center space-x-3">
              <div className="hidden sm:block relative" ref={bellRef}>
                <button
                  ...
                  title={unreadCount > 0 ? `You have ${unreadCount} unread notifications` : "Notification"}
                >
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden z-50">
                    <div className="max-h-80 overflow-auto">
                      {notifications.length === 0 ? (
                        <div className="p-4 text-sm text-slate-600">Notifications</div>
                      ) : (
                        notifications.map((n) => (
          ...
          <div className="bg-white rounded-2xl shadow-xl w-80 p-6 relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex space-x-3">
                <button
                  onClick={() => setShowLogoutModal(false)}
                  className="px-4 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  onClick={handleLogout}
                  className="px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-cyan-600 text-white hover:opacity-90 transition-all cursor-pointer"
                >
                  Yes, Logout
                </button>
              </div>
